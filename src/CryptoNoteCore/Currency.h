...
public:
  ...
  bool getBlockReward(difficulty_type difficulty, uint8_t blockMajorVersion, size_t medianSize, size_t currentBlockSize, uint64_t alreadyGeneratedCoins, uint64_t fee,
