	...
	wallet_rpc::COMMAND_RPC_TRANSFER::response& res)
{
	...
	try
	{
		...
		CryptoNote::TransactionId tx = m_wallet.sendTransaction(transfers, req.fee == 0 ? m_currency.minimumFee() : req.fee, extraString, req.mixin, req.unlock_time, req.overt);
